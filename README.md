...
**Работает.** Триквестр на живых данных: уровни, Сила, Боль, слабое звено. Канон целиком — 22 документа, 203 секции, 418 тезисов, со ссылками и якорями. Оснащение: десять Основ по одной, Договор Консенсуса, ранг Предтечи. Пять Заветов из шести: АКТ и БЛАГ закрываются одним касанием; ПУТЬ замкнут вечер→утро — Декларация на завтра с валидатором, чек-лист сегодняшней, След и Свиток недели; ДУХ — практика Тишины на три стадии с записью озарений; ДАР — приватный журнал недели. Вход через Telegram — из Mini App и из браузера, в один аккаунт.

**Следующее.** Завет ПОСТ: Дни Очищения, окно еды и Месяц Искупления с автоитогами.
