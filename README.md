...
**Работает.** Триквестр на живых данных: уровни, Сила, Боль, слабое звено. Канон целиком — 22 документа, 203 секции, 418 тезисов, со ссылками и якорями. Оснащение: десять Основ по одной, Договор Консенсуса, ранг Предтечи. Заветы АКТ и БЛАГ закрываются одним касанием. Завет ПУТЬ замкнут вечер→утро: Декларация на завтра с валидатором, чек-лист сегодняшней, закрытие дня с отражением, След пройденного и Свиток недели. Вход через Telegram — из Mini App и из браузера, в один аккаунт.

**Следующее.** Заветы ДУХ (Тишина на три стадии) и ДАР.
