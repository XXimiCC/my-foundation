...
Готово: геометрия и компонент Триквестра, доменная математика оболочек, схема данных, разбор хранилища (22 документа, 203 секции, 418 тезисов).

Дальше: импорт Канона в БД и читалка, Оснащение, ритуалы бота, Декларации, Тишина, Пост, Слово Дня.
